  ...
  const recentActivities = [
    {
      ...
      type: "Sale",
      description:
        "Sales Order SO-2024-1247 from ABC Manufacturing Ltd for Industrial Valves",
