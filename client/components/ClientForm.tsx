...
import { ClientRequest, EntityResponse, ContactPerson, BankDetails } from "@shared/entities";
      ...
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Row 1: Client Name, Printed Name, Client Category */}
            <div>
              <label className="block text-sm font-medium text-blue-600 mb-2">Client Name</label>
              <input
                type="text"
                name="clientName"
                ...
                required
              />
              <p className="text-xs text-gray-500 mt-1">Please enter name of the client.</p>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-blue-600 mb-2">Client Category</label>
              <select
                name="clientCategory"
