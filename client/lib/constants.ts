...
export const COMPANY_INFO = {
  ...
  heroImage:
    "https://cdn.builder.io/api/v1/image/assets%2F54f8588728e94fb0b8646e3f37922df0%2F18131d2f53ad4e7780e2c0e6abcabfe9?format=webp&width=800",
  defaultUser: {
    username: "admin",
    password: "123",
  },
      ...
      { id: "quotations", label: "Quotations", path: "/dashboard/quotations" },
      {
        ...
        submenu: [
          ...
          { id: "receipt", label: "Receipt", path: "/dashboard/sales/receipt" },
          {
            ...
            path: "/dashboard/sales/followup",
          },
          {
            id: "credit-note",
            label: "Credit Note",
            path: "/dashboard/sales/credit-note",
          },
        ],
      },
      {
        ...
        submenu: [
          {
            ...
            path: "/dashboard/purchase/materials",
          },
          {
            id: "purchase-order",
    ...
    items: [
      {
        ...
        path: "/dashboard/estimate-approvals",
      },
      {
        id: "secondary-purchase",
        label: "Secondary Purchase",
        path: "/dashboard/secondary-purchase",
      },
      {
        id: "estimate-approvals-items",
        label: "Estimate/Approvals Items",
        path: "/dashboard/estimate-approvals-items",
      },
    ],
  },
] as const;
...
export const SAMPLE_PRODUCTS = [
  {
    ...
    description:
      "Stainless steel ball valve with 2-inch diameter, suitable for high-pressure applications",
  },
  {
    id: "PROD-002",
    ...
    description:
      "High-grade PVC pipe for industrial plumbing and drainage systems",
  },
  {
    id: "PROD-003",
    ...
    description:
      "5HP centrifugal pump with stainless steel impeller for industrial applications",
  },
  {
    id: "PROD-004",
    ...
    description:
      "ANSI approved safety helmet with adjustable chin strap in white color",
  },
  {
    id: "PROD-005",
    ...
    description:
      "Galvanized steel pipe 2-inch diameter, 3-meter length for industrial use",
  },
] as const;
