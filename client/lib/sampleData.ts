...
export const SAMPLE_ORDERS = [
  {
    ...
    products: [
      { name: "Industrial Ball Valve 2 inch", quantity: 15, unitPrice: 2850, total: 42750 },
      { name: "Safety Helmet with Chin Strap", quantity: 50, unitPrice: 485, total: 24250 }
    ],
    totalAmount: 67000,
  ...
  },
  {
    ...
    products: [
      { name: "Electric Centrifugal Pump 5HP", quantity: 2, unitPrice: 18500, total: 37000 },
      { name: "PVC Pipe 4 inch x 6 meter", quantity: 20, unitPrice: 1250, total: 25000 }
    ],
    totalAmount: 62000,
  ...
  },
  {
    ...
    products: [
      { name: "Galvanized Steel Pipe 2 inch", quantity: 100, unitPrice: 850, total: 85000 },
      { name: "Industrial Ball Valve 2 inch", quantity: 25, unitPrice: 2850, total: 71250 }
    ],
    totalAmount: 156250,
...
export const SAMPLE_INVOICES = [
  {
    ...
    orderNumber: "SO-2024-1247",
    clientName: "ABC Manufacturing Ltd",
    clientAddress: "Plot 15, Industrial Area, Phase-II, Gurgaon, Haryana 122001",
...
export const SAMPLE_QUOTATIONS = [
  {
    ...
    products: [
      { name: "Galvanized Steel Pipe 2 inch", quantity: 100, unitPrice: 850, total: 85000 },
      { name: "Industrial Ball Valve 2 inch", quantity: 25, unitPrice: 2850, total: 71250 },
      { name: "PVC Pipe 4 inch x 6 meter", quantity: 50, unitPrice: 1250, total: 62500 }
    ],
    subtotal: 218750,
    discountPercent: 5,
    ...
    notes: "Bulk discount applied. Installation support can be provided at additional cost.",
  ...
  },
  {
    ...
    products: [
      { name: "Electric Centrifugal Pump 5HP", quantity: 5, unitPrice: 18500, total: 92500 },
      { name: "Safety Helmet with Chin Strap", quantity: 100, unitPrice: 485, total: 48500 }
    ],
    subtotal: 141000,
    discountPercent: 3,
    discountAmount: 4230,
...
export const SAMPLE_PURCHASE_ORDERS = [
  {
    ...
    products: [
      { name: "Industrial Ball Valve 2 inch", quantity: 50, unitPrice: 2200, total: 110000 },
      { name: "Ball Valve 1 inch", quantity: 25, unitPrice: 1800, total: 45000 }
    ],
    subtotal: 155000,
  ...
  },
  {
    ...
    products: [
      { name: "Safety Helmet with Chin Strap", quantity: 200, unitPrice: 385, total: 77000 },
...
export const SAMPLE_ENQUIRIES = [
  {
    ...
    description: "We need quotation for 10 units of 5HP centrifugal pumps and 20 units of 2-inch ball valves for our new facility.",
  ...
  },
  {
    ...
    description: "Requirement for various pipe sizes and fittings for our residential project. Need competitive rates.",
...
export const SAMPLE_MATERIALS_RECEIVED = [
  {
    ...
    qualityCheck: "passed",
    notes: "2 units of 1-inch valve short delivered. Supplier will deliver balance in next shipment.",
